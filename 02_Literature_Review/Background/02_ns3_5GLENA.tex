...
The 5G-LENA module extends ns-3 with a 3GPP-compliant 5G NR stack, implementing \texttt{PHY}, \texttt{MAC}, \texttt{RLC}, and \texttt{PDCP} layers with flexible OFDMA schedulers, link adaptation, and MIMO beamforming \cite{5glena,bojovic_mimo,bojovic_beamforming}.
