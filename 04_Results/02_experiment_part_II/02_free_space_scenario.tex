...
The stochastic ns-3 model outperforms Sionna~RT in average downlink throughput: at $8\times8$, ns-3 delivers $4.85$~Mbit~s$^{-1}$ with $21.6\%$ loss versus $3.77$~Mbit~s$^{-1}$ with $26.6\%$ loss for Sionna~RT, with the same ordering at $2\times2$.
...
Channel quality improves monotonically with array size in both simulators, with ns-3 reporting marginally higher values than Sionna~RT at each configuration.
The difference is small in free space because most links are near-line-of-sight; beamforming gain raises link quality but cannot overcome path loss for the most remote UEs.
