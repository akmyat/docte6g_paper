...
\end{itemize}
The height of gNB antenna is set to different values depending on the radio environments.
The UE positions are generated randomly in the given environments and the distance between gNB and UEs are set according to the environments.
