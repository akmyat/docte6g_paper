...
\begin{figure}[t]
    \centering
    \subfloat[Free space.]{\includegraphics[width=0.32\linewidth]{images/free_space.png}\label{fig:scenario_free_space}}
    \hfill
    \subfloat[Urban macro.]{\includegraphics[width=0.32\linewidth]{images/urban_macro.png}\label{fig:scenario_urban_macro}}
    \hfill
    \subfloat[Urban micro.]{\includegraphics[width=0.32\linewidth]{images/urban_micro.png}\label{fig:scenario_urban_micro}}
