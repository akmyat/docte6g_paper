\section{Experiment Part I: Runtime Scaling of the Embedded Ray-Traced Channel}
...
We compare three channel backends: \texttt{pure ns-3}, \texttt{ns3sionna}, and \texttt{sionnart}.
The \texttt{pure ns-3} backend uses the standard ns-3 stochastic propagation model,
